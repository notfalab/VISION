...
const TELEGRAM_CHANNELS = [
  { label: "VISION GOLD", href: "https://t.me/+_pMYNBlFj0I0YzMx", emoji: "🥇", gradient: "from-amber-500/20 to-yellow-600/20 border-amber-500/30 hover:border-amber-400/60" },
  { label: "VISION BITCOIN", href: "https://t.me/+9qAF1vBDdTkwYWVh", emoji: "₿", gradient: "from-orange-500/20 to-amber-600/20 border-orange-500/30 hover:border-orange-400/60" },
  { label: "VISION FOREX", href: "https://t.me/+rV8dmhYnX804ZjY5", emoji: "💱", gradient: "from-blue-500/20 to-cyan-600/20 border-blue-500/30 hover:border-blue-400/60" },
];
            ...
            <div className="space-y-2">
              {TELEGRAM_CHANNELS.map((ch) => (
                ...
                >
                  ...
                  <ArrowRight className="w-3.5 h-3.5 text-[var(--color-text-muted)] group-hover:text-[var(--color-text-primary)] group-hover:translate-x-0.5 transition-all" />
                </a>
              ))}
            </div>
          </div>
